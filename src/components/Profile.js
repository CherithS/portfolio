                ...
                <Section>
                    <SectionOutline>
                        ...
                        <MiddleProfile>
                            ...
                            <Box>
                                <p style={{ fontSize: '8px', textAlign: 'left' }}><span style={{ fontWeight: 800 }}>Dislikes:</span> Negativity, stereotyping, puppy mills, slow internet, employees-only restrooms, long lines</p>
                            </Box>
                            <div className='card' style={{ display:'flex', width: 'inherit', height: '5vh', backgroundColor: 'transparent', border: '5px solid #FFE600', justifyContent: 'center', flexDirection: 'center', alignItems: 'center', cursor: 'pointer' }}>
